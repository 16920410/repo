        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
                    <!--
                        <a class="btn btn-primary" href="{{ URL::to('/docentepdf') }}">Descargar PDF</a>
                    -->
                    <div align="right">

                    <a class="btn btn-outline-danger" href="{{ URL::to('/docentepdf') }}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
